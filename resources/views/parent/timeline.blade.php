...
<a href="{{ route('parent.report', $student) }}" class="ni"><div class="ni-ico" style="background:rgba(29,158,117,0.2);">📋</div> Health Report</a>
<a href="{{ route('parent.timeline', $student) }}" class="ni active" style="background:rgba(59,130,246,0.15);color:#fff;"><div class="ni-ico" style="background:rgba(59,130,246,0.3);">📈</div> Timeline</a>
